...
SOAP_SOURCE_STAMP("@(#) soapServer.c ver 2.8.131 2023-11-10 20:08:22 GMT")
...
{	struct blackJackns__getStatus soap_tmp_blackJackns__getStatus;
	...
	if (soap_body_end_in(soap)
	 ...
	 || soap_end_recv(soap))
		return soap->error;
	soap->error = blackJackns__getStatus(soap, soap_tmp_blackJackns__getStatus.gameId, soap_tmp_blackJackns__getStatus.playerName, soap_tmp_blackJackns__getStatusResponse.status);
	if (soap->error)
		return soap->error;
	soap->encodingStyle = ""; /* use SOAP encoding style */
	soap_serializeheader(soap);
...
{	struct blackJackns__playermove soap_tmp_blackJackns__playermove;
	...
	if (soap_body_end_in(soap)
	 ...
	 || soap_end_recv(soap))
		return soap->error;
	soap->error = blackJackns__playermove(soap, soap_tmp_blackJackns__playermove.gameId, soap_tmp_blackJackns__playermove.playerName, soap_tmp_blackJackns__playermove.playerMove, soap_tmp_blackJackns__playermoveResponse.status);
	if (soap->error)
		return soap->error;
	soap->encodingStyle = ""; /* use SOAP encoding style */
	soap_serializeheader(soap);
