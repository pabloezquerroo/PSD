...
\******************************************************************************/
    ...
    SOAP_FMAC5 int SOAP_FMAC6 blackJackns__getStatus(struct soap*, int gameId, struct tMessage playerName, struct tBlock *status);
    /** Web service operation 'blackJackns__playermove' implementation, should return SOAP_OK or error code */
    SOAP_FMAC5 int SOAP_FMAC6 blackJackns__playermove(struct soap*, int gameId, struct tMessage playerName, unsigned int playerMove, struct tBlock *status);
