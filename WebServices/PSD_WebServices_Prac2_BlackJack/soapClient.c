...
SOAP_SOURCE_STAMP("@(#) soapClient.c ver 2.8.131 2023-11-10 20:08:22 GMT")
...
SOAP_FMAC5 int SOAP_FMAC6 soap_call_blackJackns__getStatus(struct soap *soap, const char *soap_endpoint, const char *soap_action, int gameId, struct tMessage playerName, struct tBlock *status)
{	if (soap_send_blackJackns__getStatus(soap, soap_endpoint, soap_action, gameId, playerName) || soap_recv_blackJackns__getStatus(soap, status))
		return soap->error;
	return SOAP_OK;
}
...
SOAP_FMAC5 int SOAP_FMAC6 soap_call_blackJackns__playermove(struct soap *soap, const char *soap_endpoint, const char *soap_action, int gameId, struct tMessage playerName, unsigned int playerMove, struct tBlock *status)
{	if (soap_send_blackJackns__playermove(soap, soap_endpoint, soap_action, gameId, playerName, playerMove) || soap_recv_blackJackns__playermove(soap, status))
		return soap->error;
	return SOAP_OK;
}

SOAP_FMAC5 int SOAP_FMAC6 soap_send_blackJackns__playermove(struct soap *soap, const char *soap_endpoint, const char *soap_action, int gameId, struct tMessage playerName, unsigned int playerMove)
